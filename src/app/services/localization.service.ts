  ...
  constructor(@Inject(PLATFORM_ID) private platformId: Object,
    ...
    switch (this.currentLanguage) {
      case LANGUAGES.RUSSIAN:
        ...
        http.get('/api/v1/admin/localization/get?language=ru')
          .subscribe(res => this.currentDictionary.next(res['localizationConfig']));
        break;
      case LANGUAGES.ENGLISH:
        this.currentDictionary.next(ENGLISH_DICTIONARY);
        http.get('/api/v1/admin/localization/get?language=en')
          .subscribe(res => this.currentDictionary.next(res['localizationConfig']));
        break;
    }
  }
