export const ENGLISH_DICTIONARY = {
  ...
  'HEADER_NEWS': 'News',
  'FOR_EMPLOYER': 'СV',
  'FOR_PARTNERSHIPS': 'Business connections',
  'SUPPORT': 'SUPPORT',
  'ACCOUNT': 'Profile',
  ...
  'HOME_PAGE_CONTENT_1_2': 'current job ',
  ...
  'HOME_PAGE_CONTENT_2_3': 'of the Oil&Gas and Mining industries. Just create job list and wait for the response of candidates.',
  ...
  'RECENTLY_ADDED': 'Latest postings',
  'CVS': 'CV\'s',
  'VACANCIES': 'Jobs',
  'SEE_ALL_VACANCIES': 'See all Jobs',
  ...
  "I_AM_CANDIDATE": "Job seeker",
  "I_AM_EMPLOYER": "Employer",
  ...
  'ACCOUNT_PAGE_TAB_RESPOND_DESC_EMPLOYER': 'This section shows the answers to your job list. You can accept or reject the incoming response.',
  ...
  'TRAINING': 'Training',
  'TRAINING_ADD': 'Upload',
  'TRAINING_YEAR': 'Year of graduation',
  ...
  "NOTIFICATIONS_PERSONAL_ACCOUNT": "Profile",
  ...
  "FAQ_NOT_FOUND_ANSWER": "Did not find the answer you want or want to leave a comment or suggestions for improvements to the portal?",
  "FAQ_SEND_QUESTION": "Write",
  "FAQ_SEND_QUESTION_DESC": "Write your question and we will answer you",
  ...
  'FAQ_PAGE_ANSWER_1': 'If you want to reset your password, please go to the <a href="/auth" class="inline-link">Login page</a>. <br> <br> Click "Forgot your password?" at the bottom of the selected login field. Click Submit. If you have an account, you will receive an email. If you have not received the letter, check the "Spam" folder. <br> <br> Follow the link as soon as you receive an email, as the link expires after 24 hours.',
  'FAQ_PAGE_QUESTION_2': 'Editing, updating and deactivating resume',
  'FAQ_PAGE_ANSWER_2': 'If you want to edit, update or deactivate your resume, log in to your account. <br> <br> Click Edit or Add next to the field you want to edit. If you want to delete a change or a field - click the X next. All you need to do is add to the list of changes and additions. To deactivate or replace a resume, click Deactivate or replace a resume in a resume (in the upper right corner). You can create a new resume.',
  ...
  'MY_CITY_DOESNOT_HAVE_IS_LIST': 'Is a city not listed?',
  'ADMIN': 'Administrator',
  'YOU': 'You',
  'NEW_MESSAGE': 'A new message',
  'MESSAGES_PAGE_HEADER': 'Messages',
  'MESSAGES_PAGE_TITLE': 'Correspondence',
  'VACANCY_WAS_DELETED': 'Job has been removed.',
  'SALARY_AFTER_MEETING': 'Salary is negotiable',
  'BLOCKED': 'Blocked',
  'RESTORE_PASSWORD_TITLE': 'Password recovery',
  'RESTORE_PASSWORD_INPUT_NEW_PASSWORD': 'Enter a new password',
  'RESTORE_PASSWORD_SAVE_PASSWORD': 'Save password',
  'RESTORE_PASSWORD_DESCRIPTION': 'Enter mail from your account. We will send you a link to reset your password.',
  'RESTORE_PASSWORD_SEND_LINK': 'Send link',
  'CURRENCY': 'Currency',
  'AWAITING_VERIFY': 'Verification on review',
  'VERIFY_COMMENT_LABEL': 'Transmittal letter',
  'SEND_VERIFY_REQUEST': 'Send request',
  'VERIFY_LABEL_1': 'Account verification is required to improve the image, reputation, organization status and full access to all services of the Cenozoic Community HR platform.',
  'VERIFY_LABEL_2': 'To verify your account, please follow these rules:',
  'VERIFY_POINT_1': 'Documents confirming your relationship with the organization you represent should be dated no more than 7 days ago;',
  'VERIFY_POINT_2': 'Documents must necessarily be issued on the organization’s letterhead and must contain the full company name of the organization, contact details (office address, phone numbers, e-mail);',
  'VERIFY_POINT_3': 'The documents must be signed by an authorized person with the appropriate formulations about the representation of the interests of the organization in your person;',
  'VERIFY_POINT_4': 'Scanned copies of documents must be made in good quality (all characters are clearly readable and are not in doubt).',
  'SORT_BY_COMMENT': 'Most Commented',
  'NOTIFICATIONS_LABEL': 'By agreeing, you subscribe to the distribution of useful information about vacancies \\ resumes and information from the administrator'
};
