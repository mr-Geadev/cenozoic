export const RUSSIAN_DICTIONARY = {
  ...
  'VERIFY_LABEL_1': 'Верификация аккаунта необходима для повышения имиджа, репутации, статуса  организации и полного доступа всех сервисов HR-платформы Cenozoic Community. ',
