export const RUSSIAN_DICTIONARY = {
  ...
  'ACCOUNT_PAGE_TAB_QUESTIONNAIRES_DESC': 'В этом разделе показаны все ваши опросные листы. Вы можете просмотреть и отредактировать нужное, кликнув по нему"',
  'ACCOUNT_PAGE_TAB_NEWS_DESC': 'В этом разделе показаны все ваши новости. Вы можете просмотреть и отредактировать нужную, кликнув по ней"',
  'ACCOUNT_PAGE_TAB_BANNERS_DESC': 'В этом разделе показаны все ваши баннеры. Вы можете просмотреть и отредактировать нужный, кликнув по ней"',
  'ACCOUNT_PAGE_TAB_CV_DESC': 'В этом разделе показаны все ваши резюме. Вы можете просмотреть и отредактировать нужное, кликнув по нему"',
  ...
  'MY_CITY_DOESNOT_HAVE_IS_LIST': 'Нужного города нет в списке?',
  'ADMIN': 'Администратор',
  'YOU': 'Вы',
  'NEW_MESSAGE': 'Новое сообщение',
  'INVALID_FIELD': 'Поле введено неверно',
  'MESSAGES_PAGE_HEADER': 'Сообщения',
  'MESSAGES_PAGE_TITLE': 'Переписки',
  'VACANCY_WAS_DELETED': 'Вакансия была удалена',
  'SALARY_AFTER_MEETING': 'З/П договорная',
  'BLOCKED': 'Заблокировано',
  'RESTORE_PASSWORD_TITLE': 'Восстановление пароля',
  'RESTORE_PASSWORD_INPUT_NEW_PASSWORD': 'Введите новый пароль',
  ...
  'CURRENCY': 'Валюта',
  'AWAITING_VERIFY': 'Верификация на расммотрении',
  'VERIFY_COMMENT_LABEL': 'Сопроводительное письмо',
  'SEND_VERIFY_REQUEST': 'Отправить запрос',
  'VERIFY_LABEL_1': 'Верификация аккаунта необходима повышения имиджа, репутации, статуса  организации и полного доступа всех сервисов HR-платформы Cenozoic Community. ',
  'VERIFY_LABEL_2': 'Для подтверждения аккаунта, пожалуйста, следуйте этим правилам:',
  'VERIFY_POINT_1': 'Документы, подтверждающие ваши взаимоотношения с организацией, которую вы представляете, должны быть  датированы не более 7-и дней назад;',
  'VERIFY_POINT_2': 'Документы в обязательном порядке должны быть выпущены на фирменном бланке организации и должны содержать полное фирменное наименование организации, контактные данные (адрес   офиса, телефоны, е-мейл);',
  'VERIFY_POINT_3': 'Документы должны быть подписаны уполномоченным лицом с соответствующими формулировками о представлении интересов организации в вашем лице;',
  'VERIFY_POINT_4': 'Скан-копии документов должны быть выполнены в хорошем качестве (все символы отчётливо читаются и не вызывают сомнения).',
  'SORT_BY_COMMENT': 'Самые комментируемые',
  'NOTIFICATIONS_LABEL': 'Давая согласие вы подписываетесь на рассылку полезной информации о вакансиях\\резюме и информацию от администратора'
};
