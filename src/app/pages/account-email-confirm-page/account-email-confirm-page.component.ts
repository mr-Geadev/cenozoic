...
@Component({
    ...
    templateUrl: './account-email-confirm-page.component.html',
    styleUrls: ['./account-email-confirm-page.component.less']
})
export class AccountEmailConfirmPageComponent implements OnInit {
